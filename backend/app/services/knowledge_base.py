...
class KnowledgeBaseService:
    ...
    async def search_similar_problems(self, query: str, top_k: int = 5) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for result in search_results:
                results.append({
                    "content": result.payload.get("question", ""),
                    "solution": result.payload.get("final_answer", ""),
