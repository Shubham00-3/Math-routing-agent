...
#     MCP_SEARCH_SERVER_PATH: str = str(PROJECT_ROOT / "mcp" / "servers" / "search_server.py")
...
# Define PROJECT_ROOT outside the class
PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent
...
class Settings(BaseSettings):
    ...
    MCP_SERVER_HOST: str = "localhost"
    MCP_SERVER_PORT: int = 8080
    # Now, use the variable defined outside the class
    MCP_SEARCH_SERVER_PATH: str = str(PROJECT_ROOT / "mcp" / "servers" / "search_server.py")
